...
import { getDb, getOne, query } from './client';
...
export async function seedDemoData() {
  try {
    ...
    // Create demo user for dashboard login
    ...
    if (!existingUser) {
      ...
      console.log(`Demo user created: fjordtech@demo.no`);
    }

    console.log(`Demo data seeded for site: ${siteId}`);
  } catch (err) {
